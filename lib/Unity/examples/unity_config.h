 ...
 *
 * Example:
 * Say you are forced to run your unittest suite on an embedded processor with no
 * `stdout` option. You decide to route your unittest result output to a custom
...
/* Print execution time of each unittest when executed in verbose mode
 *
 * Example:
 *
 * TEST - PASS (10 ms)
